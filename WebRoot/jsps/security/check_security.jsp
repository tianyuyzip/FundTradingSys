...
<body>
  ...
  <h3 class="page-header">请输入密码</h3>
		<s:form cssClass="form-horizontal" namaspace="/transinfo"
			action="checkAccountPwd" method="post" id="myform">
			<div class="form-group" style="margin-top:100px">
				<label class="control-label col-sm-2" for="pwd">请输入密码:</label>
				<div class="col-md-7">
					<s:password cssClass="form-control" placeholder="输入6位数密码" id="desc"
						name="pwd"></s:password>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<s:submit value="确认密码" cssClass="btn btn-primary" id="bt"></s:submit>
				</div>
			</div>
		</s:form>
	</div>
