...
<body>
	<div class="container">
		...
		<s:form cssClass="form-horizontal" namaspace="/acctransinfo"
			action="saveMoney" method="post" id="myform">
			<div class="form-group">
				<label class="control-label col-sm-2" for="name">请输入存入金额:</label>
				<div class="col-md-4">
					<s:textfield cssClass="form-control"  id="name" placeholder="输入存入金额"
