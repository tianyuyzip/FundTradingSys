...
<body>
	<div class="container">
		<h3 class="page-header">修改基金产品信息</h3>
		<s:form cssClass="form-horizontal" namaspace="/fund"
			action="updateFund" method="post" id="myform">
			<s:hidden name="fund.fundNo"></s:hidden>
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<s:submit value="修改" cssClass="btn btn-primary" id="bt"></s:submit>
				</div>
			</div>
		</s:form>
	</div>
